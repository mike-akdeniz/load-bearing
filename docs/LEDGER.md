...
| The paper states its own conditions | u8eu | Every process measured wrote tests — *provided that they keep writing tests*; test-first and test-last are substitutes *at the same level of granularity and uniformity*; gains may be small or uncertain short-term; long-term test-first benefits were not measured | cite |
